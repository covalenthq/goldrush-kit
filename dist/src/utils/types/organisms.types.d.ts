...
import { type BalanceItem, type BlockTransactionWithContractTransfers, type Chain } from "@covalenthq/client-sdk";
...
export interface BlockTransactionWithContractTransfersWithDelta extends BlockTransactionWithContractTransfers {
    delta_quote: number;
    delta: bigint | null;
}
...
//# sourceMappingURL=organisms.types.d.ts.map